...
6. **Git (post–Phase 4)**  
   - `main`: `05_slack_exports/phase_4_preview.md`, `06_decisions/meeting_notes_2026-04-22_zoom1.md`, this `cp_current.md`.  
   - Each RA branch: `research-log/phase4_zoom1.md` (alignment checksum).
